        ...
        <div className=' container' style={{ marginTop: "4%", padding: "0 10%" }}>
            ...
            <div className="row mt-5">
                <div className="col-lg-6  text-center">
                    <img src="media/images/Parikshit.1.png" alt="parikshitjaiswal" width="70%" className='rounded-circle' />
                    <p className='fs-5 mt-3'>Parikshit Jaiswal</p>
                    <p>Founder, CEO</p>
                </div>
                <div className="col-lg-6 mt-5">
                    <div className="pb-3">Parikshit bootstrapped and founded Zerodha in 2010 to overcome the hurdles he faced during his decade long stint as a trader. Today, Zerodha has changed the landscape of the Indian broking industry.</div>
